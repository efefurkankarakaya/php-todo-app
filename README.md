...
<br />
<b>NOTE:</b> "www" folder is not required, you can clone it to any folder (ex: Downloads) and access by <monospace>localhost:4000/Downloads/notes-app/index.php</monospace>
